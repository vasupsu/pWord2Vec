...
def main():
    ...
    print 'Word Analogy', '\t%0.3f' % accuracy_add
#    print 'Word Analogy', '\t%0.3f' % accuracy_add, '\t%0.3f' % accuracy_mul
...
def evaluate(representation, data, xi, ix):
    ...
    for a, a_, b, b_ in data:
        ...
        if b_mul == b_:
            correct_mul += 1
#            print ('Right predict ', a, a_, b, 'predicted ', b_mul, ' act ', b_)
#        else:
#            print ('wrong predict ', a, a_, b, 'predicted ', b_mul, ' act ', b_)
